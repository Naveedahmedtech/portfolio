...
function HomeSection() {
    ...
    return (
        ...
        >
            ...
            <motion.div
                className="relative w-full max-w-5xl text-textPrimary p-4 py-12 md:p-12 text-center bg-gradient-to-br from-gray-900 bg-opacity-80 rounded-3xl shadow-2xl"
